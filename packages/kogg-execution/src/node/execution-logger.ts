...
export function executionLog<K extends keyof Fields>(event: K, fields: Fields[K]): void {
  ...
  else if (event === 'target-binding.requested') console.debug('[kogg:execution:target] target-binding.requested', fields);
  else if (event === 'target-binding.completed') console.info('[kogg:execution:target] target-binding.completed', fields);
  else if (event === 'target-binding.refused') console.warn('[kogg:execution:target] target-binding.refused', fields);
