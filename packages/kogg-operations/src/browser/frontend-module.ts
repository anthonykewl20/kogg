...
import { KoggOperationsReadModelService, KoggOperationsReadModelServicePath } from '../common/operations-read-model-protocol';
...
export default new ContainerModule(bind => {
  ...
  bind(KoggOperationsReadModelService).toDynamicValue(context => WebSocketConnectionProvider.createProxy(
    context.container, KoggOperationsReadModelServicePath, context.container.get(OperationsClient)
  )).inSingletonScope();
