...
export interface WorkflowExecutorAttestationV1 {
  readonly schemaVersion: '1'; readonly executorId: 'kogg.workflow.control' | 'kogg.tasks.admission' | 'kogg.agents.registry'; readonly executorVersion: '1.0.0';
  readonly executionKind: 'in-process-deterministic' | 'task-admission-witness' | 'supervised-registry'; readonly ownerKind: 'workflow' | 'task' | 'kogg'; readonly artifactDigest: string;
