  ...
  async diagnose(): Promise<readonly KoggDiagnosticCheck[]> {
    try {
      ...
      return [
        ...
        { id: 'workflow.authority', status: 'fail', summary: 'Task-scoped mode entry and immutable role/provider declarations are integrated; runtime role/provider resolution, evidence, verdict, and merge grants remain unavailable.', details: { safeCode: 'WORKFLOW_AUTHORITY_EXPANSION' } },
