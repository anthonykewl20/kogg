  ...
  async diagnose(): Promise<readonly KoggDiagnosticCheck[]> {
    try {
      ...
      return [
        ...
        { id: 'workflow.authority', status: 'fail', summary: 'Task-scoped mode entry and authoritative role/provider/adapter resolution are integrated; evidence, verdict, and merge grants remain unavailable.', details: { safeCode: 'WORKFLOW_AUTHORITY_EXPANSION' } },
