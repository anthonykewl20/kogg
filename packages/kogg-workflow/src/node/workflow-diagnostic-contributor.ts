  ...
  async diagnose(): Promise<readonly KoggDiagnosticCheck[]> {
    try {
      ...
      return [
        ...
        { id: 'workflow.accessibility', status: 'fail', summary: 'The structured outline is available; equivalent spatial-canvas operations remain unavailable.', details: { safeCode: 'WORKFLOW_GRAPH_INVALID' } },
