...
export const WORKFLOW_SAFE_CODES = ['WORKFLOW_OK','WORKFLOW_SCHEMA_INVALID','WORKFLOW_VERSION_CONFLICT','WORKFLOW_CATALOG_MISMATCH','WORKFLOW_GRAPH_INVALID','WORKFLOW_CYCLE','WORKFLOW_PORT_INVALID','WORKFLOW_UNREACHABLE','WORKFLOW_JOIN_AMBIGUOUS','WORKFLOW_BOUND_EXCEEDED','WORKFLOW_CONDITION_INVALID','WORKFLOW_ANCHOR_BYPASS','WORKFLOW_AUTHORITY_EXPANSION','WORKFLOW_ROLE_SEPARATION','WORKFLOW_TARGET_MISMATCH','WORKFLOW_EXECUTOR_INCOMPATIBLE','WORKFLOW_APPROVAL_REQUIRED','WORKFLOW_APPROVAL_INVALID','WORKFLOW_DEADLINE','WORKFLOW_RETRY_REFUSED','WORKFLOW_OUTCOME_UNKNOWN','WORKFLOW_EXTERNAL_FAILURE','WORKFLOW_PROCESS_FAILED','WORKFLOW_CLEANUP_FAILED','WORKFLOW_RESIDUAL_PROCESS','WORKFLOW_RECOVERY_FAILED','WORKFLOW_STALE_EVIDENCE','WORKFLOW_STALE_VERDICT','WORKFLOW_MERGE_REFUSED','WORKFLOW_STORE_INTEGRITY','WORKFLOW_CANCELLED','WORKFLOW_INTERNAL'] as const;
export type WorkflowSafeCode = typeof WORKFLOW_SAFE_CODES[number];
...
export interface WorkflowNodeConfigurationV1 {
  ...
  readonly externalConfigurationDigest?: string;
