...
export type CodexSafeCode = 'CODEX_OK' | 'CODEX_RELEASE_UNQUALIFIED' | 'CODEX_MANIFEST_INVALID'
  ...
  | 'CODEX_PLATFORM_UNSUPPORTED' | 'CODEX_PROCESS_START_FAILED' | 'CODEX_PROTOCOL_VIOLATION'
  ...
  | 'CODEX_ABSOLUTE_TIMEOUT' | 'CODEX_CLEANUP_TIMEOUT' | 'CODEX_CLEANUP_FAILED' | 'CODEX_INTERNAL_FAILURE';
