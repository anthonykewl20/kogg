...
export type CodexSafeCode = 'CODEX_OK' | 'CODEX_RELEASE_UNQUALIFIED' | 'CODEX_MANIFEST_INVALID'
  ...
  | 'CODEX_SPAWN_TIMEOUT' | 'CODEX_INITIALIZE_TIMEOUT' | 'CODEX_THREAD_START_TIMEOUT' | 'CODEX_FIRST_ACTIVITY_TIMEOUT' | 'CODEX_ABSOLUTE_TIMEOUT' | 'CODEX_CLEANUP_TIMEOUT' | 'CODEX_CLEANUP_FAILED' | 'CODEX_INTERNAL_FAILURE';
