...
const CODEX_DEBUG_MODULES = ['backend-module', 'codex-accepted-methods', 'codex-adapter-factory', 'codex-content-router', 'codex-credential-reservation', 'codex-diagnostic-contributor', 'codex-generated-schema', 'codex-live-session', 'codex-logger', 'codex-process-host', 'codex-protocol-client', 'codex-protocol-core', 'codex-recovery-registry', 'codex-release-registry', 'codex-runtime-authority', 'codex-session-attestation', 'codex-session-cleanup', 'codex-source-map-diagnostics', 'codex-stdin-writer', 'codex-stdio-drainer'] as const;
