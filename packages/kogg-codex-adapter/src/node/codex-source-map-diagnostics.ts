...
const CODEX_DEBUG_MODULES = ['backend-module', 'codex-accepted-methods', 'codex-adapter-factory', 'codex-content-router', 'codex-diagnostic-contributor', 'codex-generated-schema', 'codex-logger', 'codex-protocol-client', 'codex-protocol-core', 'codex-release-registry', 'codex-session-cleanup', 'codex-source-map-diagnostics', 'codex-stdin-writer', 'codex-stdio-drainer'] as const;
