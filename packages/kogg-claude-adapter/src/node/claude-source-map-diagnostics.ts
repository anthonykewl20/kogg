...
const CLAUDE_DEBUG_MODULES = ['backend-module', 'claude-adapter-factory', 'claude-artifact-registry', 'claude-diagnostic-contributor', 'claude-logger', 'claude-source-map-diagnostics'] as const;
