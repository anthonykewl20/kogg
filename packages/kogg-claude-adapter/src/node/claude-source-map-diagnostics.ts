...
const CLAUDE_DEBUG_MODULES = ['backend-module', 'claude-adapter-factory', 'claude-artifact-registry', 'claude-attempt-authority', 'claude-diagnostic-contributor', 'claude-logger', 'claude-permission-gate', 'claude-recovery-registry', 'claude-runtime-authority', 'claude-sdk-protocol', 'claude-source-map-diagnostics'] as const;
