...
const CLAUDE_DEBUG_MODULES = ['backend-module', 'claude-adapter-factory', 'claude-artifact-registry', 'claude-diagnostic-contributor', 'claude-logger', 'claude-recovery-registry', 'claude-runtime-authority', 'claude-source-map-diagnostics'] as const;
