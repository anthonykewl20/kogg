...
export type ClaudeSafeCode = 'CLAUDE_OK' | 'CLAUDE_LEGAL_APPROVAL_REQUIRED' | 'CLAUDE_ARTIFACT_MISMATCH' | 'CLAUDE_RECOVERY_REQUIRED' | 'CLAUDE_UNVERIFIED_RESIDUAL' | 'CLAUDE_INTERNAL';
