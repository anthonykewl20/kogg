...
export type ClaudeSafeCode = 'CLAUDE_OK' | 'CLAUDE_LEGAL_APPROVAL_REQUIRED' | 'CLAUDE_ARTIFACT_MISMATCH' | 'CLAUDE_CONFINEMENT_UNAVAILABLE' | 'CLAUDE_CREDENTIAL_BROKER_UNAVAILABLE' | 'CLAUDE_CREDENTIAL_UNAVAILABLE' | 'CLAUDE_CREDENTIAL_REVOKED' | 'CLAUDE_PROVIDER_PROTOCOL' | 'CLAUDE_ATTEMPT_INVALID' | 'CLAUDE_INITIALIZATION_MISMATCH' | 'CLAUDE_PERMISSION_PROTOCOL' | 'CLAUDE_PERMISSION_TIMEOUT' | 'CLAUDE_PERMISSION_DENIED' | 'CLAUDE_SPAWN_FAILED' | 'CLAUDE_SPAWN_PROTOCOL' | 'CLAUDE_PROTOCOL_OVERFLOW' | 'CLAUDE_PROTOCOL_INVALID' | 'CLAUDE_MODEL_MISMATCH' | 'CLAUDE_INTERRUPTION_FAILED' | 'CLAUDE_CLOSE_FAILED' | 'CLAUDE_RESIDUAL_PROCESS' | 'CLAUDE_UNREGISTERED_PROCESS' | 'CLAUDE_RECOVERY_REQUIRED' | 'CLAUDE_UNVERIFIED_RESIDUAL' | 'CLAUDE_INTERNAL';
