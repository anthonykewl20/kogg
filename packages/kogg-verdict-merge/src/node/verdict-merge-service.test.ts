...
function fixtureAdmission(value: VerdictQueryV1): TaskAdmissionSnapshot { return {taskAdmissionId:value.taskAdmissionId,taskId:value.taskId,specificationId:'10000000-0000-4000-8000-000000000009',taskRevisionId:'10000000-0000-4000-8000-000000000009',taskRevisionDigest:`sha256:${'9'.repeat(64)}`,approvalId:'10000000-0000-4000-8000-000000000010',approvalDigest:`sha256:${value.approvalDigest}`,projectId:value.projectId,repositoryId:value.repositoryId,bindingRevision:'1',registryRevision:'1',taskRevision:'1',runId:'10000000-0000-4000-8000-000000000011',authorizedAt:'2026-08-27T00:00:00.000Z',expiresAt:'2099-08-27T00:00:00.000Z'}; }
